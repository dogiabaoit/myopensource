from tkinter import *
import sqlite3                      #https://sqlitebrowser.org/
...
b1=Button(root,text="Signup",width=12,bg='brown',fg='white',command=database)
b1.place(x=150, y=530)
root.bind("<Return>",database)      #Quay lai cua so chinh sau khi luu data xong
